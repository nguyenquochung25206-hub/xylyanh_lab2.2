"""
run_experiments.py (TV5)
=========================

Script dong lenh (CLI) de chay thi nghiem tham so Sigma + Threshold
cho Canny Edge Detection.

Cach su dung:

    # Chay voi cau hinh mac dinh (EXP-01 + EXP-02)
    python src/scripts/run_experiments.py

    # Chi dinh anh dau vao cu the
    python src/scripts/run_experiments.py --input data/input/normal/normal_01.jpg

    # Tuy chinh danh sach gia tri Sigma can thu nghiem
    python src/scripts/run_experiments.py --sigma 0.5 1.0 1.5 2.0 3.0

    # Tuy chinh danh sach cap Threshold (dinh dang low:high)
    python src/scripts/run_experiments.py --thresholds 50:100 100:200 150:300
"""
